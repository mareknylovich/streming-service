  ...
  return (
    <div className="logo-container">
      <div className="logo-scroll">
        <img src={DisneyLogo} className="logo-container-image" />
        <img src={MaxdomeLogo} className="logo-container-image" />
        <img src={NetflixLogo} className="logo-container-image" />
        <img src={PrimeVideoLogo} className="logo-container-image" />
        <img src={RakutenTvLogo} className="logo-container-image" />
        <img src={SkyStoreLogo} className="logo-container-image" />
      </div>
    </div>
  );
}
